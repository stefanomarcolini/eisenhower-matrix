...
- **Read `09-CODING-PATTERNS.md` and `10-API-SECURITY.md` before writing any code.** Every hard implementation decision is already resolved there.
...
**Docs:** `06-API-CONTRACT.md`, `01-PROJECT-OVERVIEW.md §3`
...
**Docs:** `05-DATABASE-SCHEMA.md`, `09-CODING-PATTERNS.md §12`
...
**Docs:** `05-DATABASE-SCHEMA.md`, `08-MULTI-TENANCY.md`, `09-CODING-PATTERNS.md §4, §7, §8, §20`
...
**Docs:** `07-AUTH-CONFIG.md`, `06-API-CONTRACT.md §Internal API`, `09-CODING-PATTERNS.md §15`, `11-PASSWORD-POLICY.md`
...
**Docs:** `06-API-CONTRACT.md §Tasks §Users §Admin`, `01-PROJECT-OVERVIEW.md §3`, `09-CODING-PATTERNS.md §1, §14, §16, §20`
...
**Docs:** `09-CODING-PATTERNS.md §2, §9, §13`, `12-ENV-VARS.md §BFF`, `07-AUTH-CONFIG.md §8`
...
**Docs:** `07-AUTH-CONFIG.md §2–§10`, `09-CODING-PATTERNS.md §3, §6, §17`, `10-API-SECURITY.md §API2, §API6`
...
**Docs:** `09-CODING-PATTERNS.md §5, §6`, `10-API-SECURITY.md §Request Smuggling`, `08-MULTI-TENANCY.md §3`
...
**Docs:** `09-CODING-PATTERNS.md §10`, `07-AUTH-CONFIG.md §6–§10`
**Deliverable:** Vite + React 18 + TypeScript scaffold; `tailwind.config.ts` (dark mode: class); React Router v6 routes (all paths from `09-CODING-PATTERNS.md §10`); TanStack Query provider + `useSession` hook (`GET /auth/session`); `ProtectedRoute` component; `axios` instance with CSRF interceptor (reads `XSRF-TOKEN` cookie, sets `X-XSRF-TOKEN` header on mutating requests).
**Validation:** `npm run dev` works, unauthenticated routes redirect to `/login`.

### Session 11 · Auth Pages
**Docs:** `07-AUTH-CONFIG.md §6–§10`, `11-PASSWORD-POLICY.md §1`, `09-CODING-PATTERNS.md §10`
...
**Docs:** `06-API-CONTRACT.md §Tasks`, `01-PROJECT-OVERVIEW.md §3`
...
**Docs:** `06-API-CONTRACT.md §Users`, `11-PASSWORD-POLICY.md §2–§3`, `07-AUTH-CONFIG.md §7`
...
**Docs:** `14-INFRASTRUCTURE-SPEC.md`, `09-CODING-PATTERNS.md §11`, `04-DEVELOPMENT-ENV.md`
...
**Docs:** `15-REPOSITORIES-AND-CICD.md`
...
**Docs:** `06-API-CONTRACT.md`, `07-AUTH-CONFIG.md §6–§7`
